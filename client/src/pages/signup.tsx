...
export default function Signup() {
    ...
    setTimeout(() => {
      if (username && password) {
        ...
        toast({
          ...
          description: `Welcome to EmpowerSoft, ${username}`,
        });
  ...
  return (
    <div className="min-h-screen relative overflow-hidden flex items-center justify-center px-4">
      ...
      <div className="absolute bottom-1/4 left-1/4 w-80 h-80 bg-cyan-500/20 rounded-full blur-3xl animate-float" style={{ animationDelay: "3s" }} />
      ...
      <div className="relative z-10 w-full max-w-md">
        <GlassCard className="p-8">
          <div className="mb-6 text-center">
            ...
            <p className="text-white/70">Join EmpowerSoft today</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <Button
              type="submit"
              className="w-full rounded-full py-6 text-base font-semibold bg-gradient-to-r from-cyan-500 to-purple-600 hover:from-cyan-400 hover:to-purple-500 shadow-lg shadow-purple-500/50 border-0"
              disabled={isLoading}
          ...
          <div className="mt-6 text-center">
            <p className="text-white/60 text-sm">
              ...
              <Link href="/login" className="text-cyan-400 hover:text-cyan-300 font-medium" data-testid="link-login-from-signup">
                Sign in
              </Link>
            </p>
          </div>
